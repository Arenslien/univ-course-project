...
async def main():
    async with aiohttp.ClientSession() as session:
        years = list(range(2023, 2022, -1))  # 2021년만
...
# 결과를 CSV 파일로 저장
with open('arxiv_CS_2023_full.csv', 'w', newline='', encoding='utf-8') as csvfile:
    csv_writer = csv.writer(csvfile)

    # 헤더 추가
    csv_writer.writerow(["Year", "Month", "Title", "Authors", "Subjects", "Abstract"])
