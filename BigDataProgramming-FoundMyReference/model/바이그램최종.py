...
#불용어 제거 작업이 완료된 DataFrame을 CSV 파일로 저장합니다.
df.to_csv('/content/drive/My Drive/BDPgo/All_processed_data.csv', index=False)

#df = pd.read_csv('/content/drive/My Drive/BDPgo/All_processed_data.csv')
#저장완료된거. 다음부터 쓸때 여기부터 불러와서 실행하면됨.
...
#아까 코드로 인해 2013~2023 까지의 키워드가 리스트로 sorted_list2013~2023 에 저장됌.

print(sorted_list2013)
print(sorted_list2014)
print(sorted_list2015)
print(sorted_list2016)
